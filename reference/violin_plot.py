...
class MainWindow(Adw.ApplicationWindow):
    def __init__(self, **kwargs):
        ...
        dataset3 = [random.randint(15, 30) for _ in range(45)] + [random.randint(30, 40) for _ in range(8)]  # Heavy concentration  # Small tail

        # Dataset 4: Bimodal - two distinct peaks (low and high)
        dataset4 = [random.randint(10, 20) for _ in range(20)] + [random.randint(55, 70) for _ in range(25)] + [random.randint(30, 45) for _ in range(8)]  # Low cluster  # High cluster  # Gap filler
        ...
        dataset6 = [random.randint(5, 15) for _ in range(18)] + [random.randint(25, 35) for _ in range(8)] + [random.randint(60, 74) for _ in range(22)]  # Low extreme  # Sparse middle  # High extreme
